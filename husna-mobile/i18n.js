    ...
    en: {
        translation: {
            ...
            learn: {
                ...
                close: 'Close',
                meaning: 'Meaning',
                tapHint: 'Tap to learn more',
            },
            detail: {
                sectionMeaning: 'Meaning',
                sectionQuran: 'In the Quran',
                sectionWhy: 'Why it matters',
                sectionHadith: 'Hadith',
                sectionReflection: 'Reflection',
                sectionRelated: 'Related Names',
                listen: 'Listen',
                mentionedInQuran: 'Mentioned {{count}}× in the Quran',
            },
            quiz: {
                questionArabicToMeaning: 'What does this name mean?',
                questionMeaningToArabic: 'Which name has this meaning?',
                ...
                msg0: "Keep practicing — you'll get there!",
                msg1: 'Good effort! Review the names and try again.',
                msg2: "Well done! You're getting there.",
                msg3: 'Excellent! You know the 99 Names well!',
            },
            memorize: {
                title: 'Memorize',
                revealed: 'Revealed',
    ...
    ar: {
        translation: {
            ...
            learn: {
                ...
                close: 'إغلاق',
                meaning: 'المعنى',
                tapHint: 'اضغط للمعرفة أكثر',
            },
            detail: {
                sectionMeaning: 'المعنى',
                sectionQuran: 'في القرآن',
                sectionWhy: 'لماذا يهم',
                sectionHadith: 'حديث',
                sectionReflection: 'تأمل',
                sectionRelated: 'أسماء ذات صلة',
                listen: 'استمع',
                mentionedInQuran: 'ذُكر {{count}} مرة في القرآن',
            },
            quiz: {
                questionArabicToMeaning: 'ما معنى هذا الاسم؟',
                questionMeaningToArabic: 'أي اسم له هذا المعنى؟',
                quizComplete: 'انتهى الاختبار',
                playAgain: 'العب مجدداً',
                restartTitle: 'البدء من جديد؟',
                restartMessage: 'سيُفقد تقدمك الحالي.',
                restartCancel: 'متابعة',
                restartConfirm: 'ابدأ من جديد',
                msg0: 'واصل التدريب — ستصل إليه!',
                msg1: 'جهد جيد! راجع الأسماء وحاول مجدداً.',
                msg2: 'أحسنت! أنت في الطريق الصحيح.',
                msg3: 'ممتاز! أنت تعرف الأسماء الـ 99 جيداً!',
            },
            memorize: {
                title: 'التسميع',
                revealed: 'تم الكشف',
    ...
    bs: {
        translation: {
            ...
            learn: {
                ...
                close: 'Zatvori',
                meaning: 'Značenje',
                tapHint: 'Tapni za više',
            },
            detail: {
                sectionMeaning: 'Značenje',
                sectionQuran: "U Kur'anu",
                sectionWhy: 'Zašto je važno',
                sectionHadith: 'Hadis',
                sectionReflection: 'Razmišljanje',
                sectionRelated: 'Srodna Imena',
                listen: 'Slušaj',
                mentionedInQuran: "Spominje se {{count}}× u Kur'anu",
            },
            quiz: {
                questionArabicToMeaning: 'Šta znači ovo ime?',
                questionMeaningToArabic: 'Koje ime ima ovo značenje?',
                quizComplete: 'Kviz završen',
                playAgain: 'Igraj ponovo',
                restartTitle: 'Početi ispočetka?',
                restartMessage: 'Tvoj trenutni napredak će biti izgubljen.',
                restartCancel: 'Nastavi igru',
                restartConfirm: 'Počni ispočetka',
                msg0: 'Nastavi vježbati — doći ćeš do toga!',
                msg1: 'Dobar trud! Pregledaj imena i pokušaj ponovo.',
                msg2: 'Dobro urađeno! Na dobrom si putu.',
                msg3: 'Odlično! Dobro poznaješ 99 Imena!',
            },
            memorize: {
                title: 'Pamćenje',
                revealed: 'Otkriveno',
    ...
    tr: {
        translation: {
            ...
            learn: {
                ...
                close: 'Kapat',
                meaning: 'Anlamı',
                tapHint: 'Daha fazlası için dokun',
            },
            detail: {
                sectionMeaning: 'Anlam',
                sectionQuran: "Kur'an'da",
                sectionWhy: 'Neden önemli',
                sectionHadith: 'Hadis',
                sectionReflection: 'Düşünce',
                sectionRelated: 'İlgili İsimler',
                listen: 'Dinle',
                mentionedInQuran: "Kur'an'da {{count}} kez geçiyor",
            },
            quiz: {
                questionArabicToMeaning: 'Bu ismin anlamı nedir?',
                questionMeaningToArabic: 'Bu anlama sahip isim hangisi?',
                quizComplete: 'Test Tamamlandı',
                playAgain: 'Tekrar Oyna',
                restartTitle: 'Sıfırla?',
                restartMessage: 'Mevcut ilerlemeniz kaybolacak.',
                restartCancel: 'Oynamaya devam et',
                restartConfirm: 'Sıfırla',
                msg0: 'Pratik yapmaya devam edin — başaracaksınız!',
                msg1: 'İyi çaba! İsimleri gözden geçir ve tekrar dene.',
                msg2: 'Aferin! İlerleyin.',
                msg3: 'Mükemmel! 99 İsmi çok iyi biliyorsunuz!',
            },
            memorize: {
                title: 'Ezberleme',
                revealed: 'Açılanlar',
    ...
    ur: {
        translation: {
            ...
            learn: {
                ...
                close: 'بند کریں',
                meaning: 'معنی',
                tapHint: 'مزید جاننے کے لیے ٹیپ کریں',
            },
            detail: {
                sectionMeaning: 'معنی',
                sectionQuran: 'قرآن میں',
                sectionWhy: 'کیوں اہم ہے',
                sectionHadith: 'حدیث',
                sectionReflection: 'غور و فکر',
                sectionRelated: 'متعلقہ نام',
                listen: 'سنیں',
                mentionedInQuran: 'قرآن میں {{count}} مرتبہ ذکر ہوا',
            },
            quiz: {
                questionArabicToMeaning: 'اس نام کا معنی کیا ہے؟',
                questionMeaningToArabic: 'اس معنی کا نام کون سا ہے؟',
                quizComplete: 'کوئز مکمل',
                playAgain: 'دوبارہ کھیلیں',
                restartTitle: 'دوبارہ شروع؟',
                restartMessage: 'آپ کی موجودہ پیشرفت ضائع ہو جائے گی۔',
                restartCancel: 'کھیلتے رہیں',
                restartConfirm: 'دوبارہ شروع کریں',
                msg0: 'مشق جاری رکھیں!',
                msg1: 'اچھی کوشش! نام دوبارہ دیکھیں اور کوشش کریں۔',
                msg2: 'شاباش! آپ آگے بڑھ رہے ہیں۔',
                msg3: 'بہترین! آپ 99 نام خوب جانتے ہیں!',
            },
            memorize: {
                title: 'یادداشت',
                revealed: 'ظاہر شدہ',
    ...
    id: {
        translation: {
            ...
            learn: {
                ...
                close: 'Tutup',
                meaning: 'Makna',
                tapHint: 'Ketuk untuk selengkapnya',
            },
            detail: {
                sectionMeaning: 'Makna',
                sectionQuran: 'Dalam Al-Quran',
                sectionWhy: 'Mengapa penting',
                sectionHadith: 'Hadits',
                sectionReflection: 'Renungan',
                sectionRelated: 'Nama Terkait',
                listen: 'Dengarkan',
                mentionedInQuran: 'Disebutkan {{count}}× dalam Al-Quran',
            },
            quiz: {
                questionArabicToMeaning: 'Apa arti nama ini?',
                questionMeaningToArabic: 'Nama mana yang memiliki arti ini?',
                quizComplete: 'Kuis Selesai',
                playAgain: 'Main Lagi',
                restartTitle: 'Mulai Ulang?',
                restartMessage: 'Kemajuanmu saat ini akan hilang.',
                restartCancel: 'Lanjut Bermain',
                restartConfirm: 'Mulai Ulang',
                msg0: 'Terus berlatih — kamu pasti bisa!',
                msg1: 'Usaha bagus! Tinjau nama-nama dan coba lagi.',
                msg2: 'Bagus sekali! Kamu semakin baik.',
                msg3: 'Luar biasa! Kamu sangat menguasai 99 Nama!',
            },
            memorize: {
                title: 'Menghafal',
                revealed: 'Terungkap',
    ...
    bn: {
        translation: {
            ...
            learn: {
                ...
                close: 'বন্ধ করুন',
                meaning: 'অর্থ',
                tapHint: 'আরও জানতে ট্যাপ করুন',
            },
            detail: {
                sectionMeaning: 'অর্থ',
                sectionQuran: 'কুরআনে',
                sectionWhy: 'কেন গুরুত্বপূর্ণ',
                sectionHadith: 'হাদিস',
                sectionReflection: 'চিন্তাভাবনা',
                sectionRelated: 'সম্পর্কিত নামসমূহ',
                listen: 'শুনুন',
                mentionedInQuran: 'কুরআনে {{count}} বার উল্লেখিত',
            },
            quiz: {
                questionArabicToMeaning: 'এই নামের অর্থ কী?',
                questionMeaningToArabic: 'এই অর্থের নামটি কোনটি?',
                quizComplete: 'কুইজ সম্পন্ন',
                playAgain: 'আবার খেলুন',
                restartTitle: 'নতুন করে শুরু করবেন?',
                restartMessage: 'আপনার বর্তমান অগ্রগতি হারিয়ে যাবে।',
                restartCancel: 'খেলতে থাকুন',
                restartConfirm: 'নতুন করে শুরু',
                msg0: 'অনুশীলন চালিয়ে যান!',
                msg1: 'ভালো চেষ্টা! নামগুলো আবার দেখুন।',
                msg2: 'চমৎকার! আপনি এগিয়ে যাচ্ছেন।',
                msg3: 'অসাধারণ! আপনি ৯৯টি নাম ভালোভাবে জানেন!',
            },
            memorize: {
                title: 'মুখস্থ করা',
                revealed: 'প্রকাশিত',
    ...
    fa: {
        translation: {
            ...
            learn: {
                ...
                close: 'بستن',
                meaning: 'معنی',
                tapHint: 'برای اطلاعات بیشتر ضربه بزنید',
            },
            detail: {
                sectionMeaning: 'معنی',
                sectionQuran: 'در قرآن',
                sectionWhy: 'چرا مهم است',
                sectionHadith: 'حدیث',
                sectionReflection: 'تأمل',
                sectionRelated: 'نام‌های مرتبط',
                listen: 'گوش دهید',
                mentionedInQuran: '{{count}} بار در قرآن ذکر شده',
            },
            quiz: {
                questionArabicToMeaning: 'معنی این نام چیست؟',
                questionMeaningToArabic: 'کدام نام این معنی را دارد؟',
                quizComplete: 'آزمون کامل شد',
                playAgain: 'دوباره بازی کن',
                restartTitle: 'از نو شروع کنیم؟',
                restartMessage: 'پیشرفت فعلی شما از دست خواهد رفت.',
                restartCancel: 'ادامه بازی',
                restartConfirm: 'از نو شروع کن',
                msg0: 'به تمرین ادامه دهید!',
                msg1: 'تلاش خوبی کردید! نام‌ها را مرور کنید.',
                msg2: 'آفرین! دارید پیشرفت می‌کنید.',
                msg3: 'عالی! شما ۹۹ نام را خوب می‌دانید!',
            },
            memorize: {
                title: 'حفظ کردن',
                revealed: 'آشکار شده',
    ...
    fr: {
        translation: {
            ...
            learn: {
                ...
                tapHint: 'Appuyez pour en savoir plus',
            },
            detail: {
                sectionMeaning: 'Signification',
                sectionQuran: 'Dans le Coran',
                sectionWhy: "Pourquoi c'est important",
                sectionHadith: 'Hadith',
                sectionReflection: 'Réflexion',
                sectionRelated: 'Noms associés',
                listen: 'Écouter',
                mentionedInQuran: 'Mentionné {{count}}× dans le Coran',
            },
            quiz: {
                questionArabicToMeaning: 'Que signifie ce nom ?',
                questionMeaningToArabic: 'Quel nom a cette signification ?',
                quizComplete: 'Quiz Terminé',
                playAgain: 'Rejouer',
                restartTitle: 'Recommencer?',
                restartMessage: 'Ta progression actuelle sera perdue.',
                restartCancel: 'Continuer',
                restartConfirm: 'Recommencer',
                msg0: 'Continuez à pratiquer — vous y arriverez !',
                msg1: 'Bon effort ! Révisez les noms et réessayez.',
                msg2: 'Bien joué ! Vous progressez.',
                msg3: 'Excellent ! Vous connaissez bien les 99 Noms !',
            },
            memorize: {
                title: 'Mémoriser',
                revealed: 'Révélé',
